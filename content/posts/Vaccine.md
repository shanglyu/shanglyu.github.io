...
![Screenshot from 2022-09-03 12-30-41.png](/img/Vaccine/Screenshot_from_2022-09-03_12-30-41.png)

![Screenshot from 2022-09-03 12-33-00.png](/img/Vaccine/Screenshot_from_2022-09-03_12-33-00.png)
...
![Screenshot from 2022-09-03 12-40-49.png](/img/Vaccine/Screenshot_from_2022-09-03_12-40-49.png)

- Then, I try connecting the website running port 21 and ftp service, we have file backup.zip.

![Screenshot from 2022-09-03 13-17-44.png](/img/Vaccine/Screenshot_from_2022-09-03_13-17-44.png)
...
- In order to successfully crack the password, we will have to convert the ZIP into the hash using the `zip2john` module that comes within John the Ripper:
    ...
    ![Screenshot from 2022-09-03 13-19-55.png](/img/Vaccine/Screenshot_from_2022-09-03_13-19-55.png)
...
![Screenshot from 2022-09-03 13-20-22.png](/img/Vaccine/Screenshot_from_2022-09-03_13-20-22.png)

- We can see the cracked password 741852963 . We will extract the files now:
    
    ![Screenshot from 2022-09-03 13-20-43.png](/img/Vaccine/Screenshot_from_2022-09-03_13-20-43.png)
...
![Screenshot from 2022-09-03 14-13-40.png](/img/Vaccine/Screenshot_from_2022-09-03_14-13-40.png)

- Now, I will use username and password, we just found to login to the website.

![Untitled](/img/Vaccine/Untitled.png)

![Screenshot from 2022-09-03 14-16-36.png](/img/Vaccine/Screenshot_from_2022-09-03_14-16-36.png)

- In this website, only the search box, as a result I found SQL Injection here.

![Screenshot from 2022-09-03 14-30-58.png](/img/Vaccine/Screenshot_from_2022-09-03_14-30-58.png)
...
- I think that it’s best to save `header` to a file with extension `req`
    ...
    ![Screenshot from 2022-09-03 16-04-39.png](/img/Vaccine/Screenshot_from_2022-09-03_16-04-39.png)
...
![Screenshot from 2022-09-03 16-04-55.png](/img/Vaccine/Screenshot_from_2022-09-03_16-04-55.png)
...
- We will turn on the `netcat` listener on port 443:
    ...
    ![Screenshot from 2022-09-03 16-47-45.png](/img/Vaccine/Screenshot_from_2022-09-03_16-47-45.png)
    
- Then we will execute the payload

![Screenshot from 2022-09-03 16-47-32.png](/img/Vaccine/Screenshot_from_2022-09-03_16-47-32.png)
...
![Screenshot from 2022-09-03 22-39-24.png](/img/Vaccine/Screenshot_from_2022-09-03_22-39-24.png)
...
- Note that the shell might die all of a sudden, instead of re-doing the exploit all over again, we will use SSH to login.
    ...
    ![Screenshot from 2022-09-03 22-43-56.png](/img/Vaccine/Screenshot_from_2022-09-03_22-43-56.png)
    
- Then we found the user’s flag:

![Screenshot from 2022-09-03 22-46-19.png](/img/Vaccine/Screenshot_from_2022-09-03_22-46-19.png)

- Ok, now we will type the `sudo -l` to see what privileges do we have:

![Screenshot from 2022-09-03 22-59-44.png](/img/Vaccine/Screenshot_from_2022-09-03_22-59-44.png)

So we have sudo privileges to edit the `pg_hba.conf` file using vi by running `sudo /bin/vi
/etc/postgresql/11/main/pg_hba.conf`

![Untitled](/img/Vaccine/Untitled%201.png)
...
![Screenshot from 2022-09-03 23-20-26.png](/img/Vaccine/Screenshot_from_2022-09-03_23-20-26.png)
